...
trait SettingsTrait
{
	...
	public function applyFrontSettings(): void
	{
		...
		try {
			...
			$leftAdvertising = cache()->remember('advertising.left', $this->cacheExpiration, function () {
				return Advertising::where('integration', 'unitSlot')->where('slug', 'h-left')->first();
			});
			$rightAdvertising = cache()->remember('advertising.right', $this->cacheExpiration, function () {
				return Advertising::where('integration', 'unitSlot')->where('slug', 'h-right')->first();
			});
			...
			$autoAdvertising = cache()->remember('advertising.auto', $this->cacheExpiration, function () {
			 ...
			 $midAdvertising = cache()->remember('advertising.middle', $this->cacheExpiration, function () {
				return Advertising::where('integration', 'unitSlot')->where('slug', 'middle')->first();
			});
            $rightAdvertising123 = Advertising::where('integration', 'unitSlot')->where('slug', 'h-right')->first();
            $leftAdvertising123 = Advertising::where('integration', 'unitSlot')->where('slug', 'h-left')->first();
            $midAdvertising123 = Advertising::where('integration', 'unitSlot')->where('slug', 'middle')->first();
		...
		view()->share('leftAdvertising', $leftAdvertising123);
		view()->share('rightAdvertising', $rightAdvertising123);
		view()->share('bottomAdvertising', $bottomAdvertising);
		view()->share('midAdvertising', $midAdvertising123);
