...
use App\Models\Traits\CatCombinationsTrait;
...
class CatCombinations extends BaseModel implements Feedable
{
	 ...
	 * @var string
	 */
	protected $table = 'sub_cat_combinations';
	...
	*/
	...
	public function routeNotificationForNotify(){
		...
		return setPhoneSign($phone, 'notify'); //notify lk
	}
