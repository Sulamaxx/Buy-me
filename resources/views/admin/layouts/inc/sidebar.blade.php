					...
					@if (
						...
						<li  class="sidebar-item">
							...
							<ul aria-expanded="false" class="collapse first-level">
                                ...
                                @if (userHasSuperAdminPermissions()) 
									<li class="sidebar-item">
										<a href="{{ admin_url('member_shops') }}" class="sidebar-link">
											<i class="mdi mdi-adjust"></i>
...
<!--                                    category assignments-->
                                    <li class="sidebar-item">
									<a href="{{ admin_url('packagescs') }}" class="sidebar-link">
										<i class="mdi mdi-adjust"></i>
										<span class="hide-menu">{{ trans('admin.catassign') }}</span>
									</a>
								    </li>
<!--                                category assignments-->
								</li>
					...
					@if (auth()->user()->can('page-list') || userHasSuperAdminPermissions())
						<li class="sidebar-item">
							<a href="{{ admin_url('sliders') }}" class="sidebar-link">
								<i data-feather="image" class="feather-icon"></i> <span class="hide-menu">{{ trans('Slider') }}</span>
							</a>
						</li>
					@endif
					{!! $pluginsMenu !!}
