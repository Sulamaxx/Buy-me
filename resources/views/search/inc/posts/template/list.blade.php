			...
			<div class="row">
				...
				<div class="col-sm-6 col-12 add-desc-box">
                    ...
                    if($usertypeid>1)
                    {
                        ...
                        ?>
                    <div style="background: #848484; color: aliceblue; padding-left: 3px; width: min-content; border-radius:5px;align-content: center "  >{{ $UsrType }}&nbsp;</div>
                    <?php
                    }}
                    ?>
...
//                        exit();
                        ...
                        ?>{{ $prntval }}</div><h3 class="item-price">
                    ...
                    <div><img style="width: 40px;" src="/public/images/ribbons/{{ data_get($post, 'payment.package.ribbon') }}.png" /></div>
                    <?php } ?>
				</div>
			</div>
		</div>
