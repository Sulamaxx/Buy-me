...
-->
                ...
                if (isset($rightAdvertising) && !empty($rightAdvertising))
                           {
                             ?>
                              @includeFirst([config('larapen.core.customizedViewPath') . 'layouts.inc.advertising.right','layouts.inc.advertising.right'], ['paddingTopExists' => true])
                            <?php
                           }
		...
		<div class="container mb-3">
			<div class="card border-light text-dark bg-light mb-3">
				<div class="card-body text-center">
					...
					@else
						<a id="btnPostAdlink2" href="{{ \App\Helpers\UrlGen::addPost() }}" class="btn btn-block btn-border btn-primary">
							{{ t('start_now') }}
						</a>
					@endif
				</div>
