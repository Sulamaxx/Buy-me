						...
						<div class="container mt-5">
                            <div class="row">
                                <div class="col-md-6 offset-md-3 text-center">
                                    <p>{{ t('contactus_textline1') }}</p>
                                    <p>{{ t('contactus_textline2-1') }} <strong>{{ t('contactus_textline2-2') }}</strong></p>
                                    <p>{{ t('contactus_textline3-1') }} <strong>{{ t('contactus_textline3-2') }}</strong> {{ t('contactus_textline3-3') }} <strong>{{ t('contactus_textline3-4') }}</strong></p><br>
                                    <p>{{ t('contactus_textline4') }}</p>
                                </div>
                            </div>
                        </div>
