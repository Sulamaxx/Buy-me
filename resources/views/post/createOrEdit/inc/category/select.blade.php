...
@else
	...
	@if (!empty($category))
		<p>
			<a href="#" class="btn btn-sm btn-success btn-sm-3 cat-link" style="width: 100px !important; background-color:#008D000 !important" data-id="{{ data_get($category, 'parent_id') }}">
