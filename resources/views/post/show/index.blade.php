	...
	<div class="main-container">
		...
		<div class="container">
			<div class="row">
				...
				<div class="{{$contentColSm}} page-content col-thin-right">
					@php
                ...
                if (isset($rightAdvertising) && !empty($rightAdvertising))
                           {
                             ?>
                              @includeFirst([config('larapen.core.customizedViewPath') . 'layouts.inc.advertising.right_pd','layouts.inc.advertising.right_pd'], ['paddingTopExists' => true])
                            <?php
                           }
