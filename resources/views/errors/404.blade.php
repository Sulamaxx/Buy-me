				...
				<div class="row">
					...
					<div class="col-md-12 page-content">
						...
						<div class="error-page mt-5 mb-5 ms-0 me-0 pt-5">
							<h1 class="headline text-center" style="font-size: 24px;">The page you are looking for is unavailable</h1>
							<div class="text-center mt-5">
								...
								<p>
									...
									echo "<ul><li><a href=\"/\">Return to our homepage</a></li><li><a href=\"/contact\">Contact us for help</a></li><li>Use the search bar below to find what you need.</li></ul>";
