...
?>
<!DOCTYPE html>
<html lang="<?php echo e(getLangTag(config('app.locale', 'en'))); ?>">
<head>
...
<div class="page-not-found pt-5">
	<div class="bg-light text-center shadow">
		<h2 class="fw-bold py-0 text-primary"><?php echo e($statusCode); ?></h2>
		<h3 class="mt-4 mb-3"><?php echo e($title); ?></h3>
		<p class="text-start">
			<?php
		...
		<div class="mt-5">
			<a href="<?php echo e(url('/')); ?>" class="btn m-2 m-md-0 btn-primary">
...
<?php /**PATH F:\Work\Sulochana\Buyme.lk\Buy-me\resources\views/errors/custom.blade.php ENDPATH**/ ?>