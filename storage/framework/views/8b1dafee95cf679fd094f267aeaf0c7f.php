								...
								<?php if(!config('settings.list.hide_post_type') && config('settings.single.show_listing_type')): ?>
									<?php if(!empty(data_get($post, 'postType'))): ?>
										<span class="add-type business-posts"
											  ...
											  title="<?php echo e(data_get($post, 'postType.name')); ?>"
										>
...
//                        exit();
                        ...
                        ?><?php echo e($prntval); ?></div><h3 class="item-price">
					...
					<?php if(!empty(data_get($post, 'payment.package'))): ?>
						<?php if(data_get($post, 'payment.package.has_badge') == 1): ?>
							<a class="btn btn-danger btn-sm make-favorite">
								<i class="fa fa-certificate"></i> <span><?php echo e(data_get($post, 'payment.package.short_name')); ?></span>
							</a>&nbsp;
						<?php endif; ?>
					<?php endif; ?>
                    ...
                    <div><img style="width: 40px;" src="/public/images/ribbons/<?php echo e(data_get($post, 'payment.package.ribbon')); ?>.png" /></div>
                    <?php } ?>
				</div>
			</div>
		</div>
...
<?php /**PATH C:\Users\sjeew\OneDrive\Desktop\Buy me\resources\views/search/inc/posts/template/list.blade.php ENDPATH**/ ?>