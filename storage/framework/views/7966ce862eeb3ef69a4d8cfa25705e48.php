...
<?php if($totalEntries > 0 && $isPagingable): ?>
    ...
    <ul class="pagination justify-content-center" role="navigation">
        ...
        <?php else: ?>
            <li class="page-item">
                <a class="page-link" href="<?php echo e(data_get($paginator, 'prev')); ?>" rel="prev" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>">&lsaquo;</a>
            </li>
        <?php endif; ?>
        ...
        <?php if(is_array($elements) && count($elements) > 0): ?>
            <?php $__currentLoopData = $elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php else: ?>
                    ...
                    <?php else: ?>
                        <li class="page-item"><a class="page-link" href="<?php echo e(data_get($element, 'url')); ?>"><?php echo e(data_get($element, 'label')); ?></a></li>
                    <?php endif; ?>
                <?php endif; ?>
        ...
        <?php if(data_get($paginator, 'next')): ?>
            <li class="page-item">
                <a class="page-link" href="<?php echo e(data_get($paginator, 'next')); ?>" rel="next" aria-label="<?php echo app('translator')->get('pagination.next'); ?>">&rsaquo;</a>
            </li>
        <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\sjeew\OneDrive\Desktop\Buy me\resources\views/vendor/pagination/api/bootstrap-4.blade.php ENDPATH**/ ?>