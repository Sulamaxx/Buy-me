		...
		<div class="row">
			...
			<div class="col-12 ads-parent-responsive<?php echo e($responsiveClass); ?>">
				<div class="text-center">
					<?php echo data_get($topAdvertising, 'tracking_code_large'); ?>

				</div>
			</div>
			<?php if(data_get($topAdvertising, 'is_responsive') != 1): ?>
				
				<div class="col-12 ads-parent-responsive d-none d-xl-none d-lg-none d-md-block d-sm-none">
					<div class="text-center">
						<?php echo data_get($topAdvertising, 'tracking_code_medium'); ?>
				...
				<div class="col-12 ads-parent-responsive d-block d-xl-none d-lg-none d-md-none d-sm-block">
					<div class="text-center">
						<?php echo data_get($topAdvertising, 'tracking_code_small'); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\sjeew\OneDrive\Desktop\Buy me\resources\views/layouts/inc/advertising/top.blade.php ENDPATH**/ ?>