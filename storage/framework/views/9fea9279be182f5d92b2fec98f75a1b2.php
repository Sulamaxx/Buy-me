			...
			<div class="d-flex">
				<div>
					<h4 class="card-title fw-bold">
						<span class="lstick d-inline-block align-middle"></span><?php echo e(data_get($latestUsersChart, 'title')); ?>
    ...
    <script>
        $(function () {
            ...
            var lineChartUsers = new Morris.Line({
                ...
                resize: true,
                data: <?php echo data_get($latestUsersChart, 'data'); ?>,
                xkey: 'y',
...
<?php $__env->stopPush(); ?>
<?php /**PATH F:\Work\Sulochana\Buyme.lk\Buy-me\resources\views/admin/dashboard/inc/charts/morris/line/latest-users.blade.php ENDPATH**/ ?>