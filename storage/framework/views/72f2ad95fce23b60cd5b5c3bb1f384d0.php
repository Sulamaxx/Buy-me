<style>
<?php if(isset($primaryBgColor) && !empty($primaryBgColor)): ?>
/* === Skin === */
	...
	.skin .btn-outline-primary {
		color: <?php echo e($primaryBgColor); ?>;
	...
	.skin .nav-link,
	.skin .link-color {
		color: <?php echo e($primaryBgColor10d); ?>;
	}
	.skin .text-primary {
		color: <?php echo e($primaryBgColor10d); ?> !important;
	}
	
	.skin .nav-link:focus,
	.skin .nav-link:hover {
		color: <?php echo e($primaryDarkBgColor); ?>;
	}
	...
	.skin ::selection {
		color: <?php echo e($primaryColor); ?>;
		background: <?php echo e($primaryBgColor); ?>;
	}
	...
	.skin .pace .pace-progress {
		background: <?php echo e($primaryBgColor); ?> none repeat scroll 0 0;
	}
	...
	.skin .p-price-tag {
		background: <?php echo e($primaryBgColor10); ?>;
	}
	.skin .p-price-tag::before {
		border-top-color: <?php echo e($primaryBgColor); ?>;
	}
	
	.skin .bg-primary {
		background-color: <?php echo e($primaryBgColor); ?> !important;
	}
	.skin .border-color-primary {
		border-color: <?php echo e($primaryBgColor); ?> !important;
	}
	...
	.skin .select2-container--default.select2-container--focus .select2-selection--multiple {
		border-color: <?php echo e($primaryBgColor); ?>;
		box-shadow: 0 1px 0 <?php echo e($primaryBgColor); ?>, 0 -1px 0 <?php echo e($primaryBgColor); ?>, -1px 0 0 <?php echo e($primaryBgColor); ?>, 1px 0 0 <?php echo e($primaryBgColor); ?>;
		outline: 0 none;
	}
	...
	.skin .cat-list a:not(.btn):hover {
		...
		color: <?php echo e($primaryBgColor20d); ?>;
	}
	...
	.skin .bxslider-pager .bx-thumb-item:focus {
		-webkit-box-shadow: 0 0 2px <?php echo e($primaryBgColor10d); ?>;
		-moz-box-shadow: 0 0 2px <?php echo e($primaryBgColor10d); ?>;
		box-shadow: 0 0 2px <?php echo e($primaryBgColor10d); ?>;
		outline: none;
	}
	.skin .bxslider-pager .bx-thumb-item.active,
	.skin .thumbs-gallery .swiper-slide.swiper-slide-thumb-active {
		border: 1px solid <?php echo e($primaryBgColor10d); ?>;
		border-bottom: 4px solid <?php echo e($primaryBgColor10d); ?> !important;
	}
	...
	.skin button.btn-search {
		text-shadow: 0 2px 2px <?php echo e($primaryBgColor); ?>;
		-webkit-text-shadow: 0 2px 2px <?php echo e($primaryBgColor); ?>;
	}
	...
	.skin .ln-shadow {
		background-color: <?php echo e($primaryBgColor); ?>;
		color: #fff;
		text-shadow: 1px 1px <?php echo e($primaryBgColor20d); ?>, 2px 2px <?php echo e($primaryBgColor20d); ?>, 3px 3px <?php echo e($primaryBgColor20d); ?>, 4px 4px <?php echo e($primaryBgColor20d); ?>, 5px 5px <?php echo e($primaryBgColor20d); ?>, 6px 6px <?php echo e($primaryBgColor20d); ?>, 7px 7px <?php echo e($primaryBgColor20d); ?>, 8px 8px <?php echo e($primaryBgColor20d); ?>, 9px 9px <?php echo e($primaryBgColor20d); ?>, 10px 10px <?php echo e($primaryBgColor20d); ?>, 11px 11px <?php echo e($primaryBgColor20d); ?>, 12px 12px <?php echo e($primaryBgColor20d); ?>, 13px 13px <?php echo e($primaryBgColor); ?>, 14px 14px <?php echo e($primaryBgColor); ?>, 15px 15px <?php echo e($primaryBgColor); ?>, 16px 16px <?php echo e($primaryBgColor); ?>, 17px 17px <?php echo e($primaryBgColor); ?>, 18px 18px <?php echo e($primaryBgColor); ?>, 19px 19px <?php echo e($primaryBgColor); ?>, 20px 20px <?php echo e($primaryBgColor); ?>, 21px 21px <?php echo e($primaryBgColor); ?>, 22px 22px <?php echo e($primaryBgColor); ?>, 23px 23px <?php echo e($primaryBgColor); ?>, 24px 24px <?php echo e($primaryBgColor); ?>, 25px 25px <?php echo e($primaryBgColor); ?>, 26px 26px <?php echo e($primaryBgColor); ?>, 27px 27px <?php echo e($primaryBgColor); ?>, 28px 28px <?php echo e($primaryBgColor); ?>;
		-webkit-text-shadow: 1px 1px <?php echo e($primaryBgColor20d); ?>, 2px 2px <?php echo e($primaryBgColor20d); ?>, 3px 3px <?php echo e($primaryBgColor20d); ?>, 4px 4px <?php echo e($primaryBgColor20d); ?>, 5px 5px <?php echo e($primaryBgColor20d); ?>, 6px 6px <?php echo e($primaryBgColor20d); ?>, 7px 7px <?php echo e($primaryBgColor20d); ?>, 8px 8px <?php echo e($primaryBgColor20d); ?>, 9px 9px <?php echo e($primaryBgColor20d); ?>, 10px 10px <?php echo e($primaryBgColor20d); ?>, 11px 11px <?php echo e($primaryBgColor20d); ?>, 12px 12px <?php echo e($primaryBgColor20d); ?>, 13px 13px <?php echo e($primaryBgColor); ?>, 14px 14px <?php echo e($primaryBgColor); ?>, 15px 15px <?php echo e($primaryBgColor); ?>, 16px 16px <?php echo e($primaryBgColor); ?>, 17px 17px <?php echo e($primaryBgColor); ?>, 18px 18px <?php echo e($primaryBgColor); ?>, 19px 19px <?php echo e($primaryBgColor); ?>, 20px 20px <?php echo e($primaryBgColor); ?>, 21px 21px <?php echo e($primaryBgColor); ?>, 22px 22px <?php echo e($primaryBgColor); ?>, 23px 23px <?php echo e($primaryBgColor); ?>, 24px 24px <?php echo e($primaryBgColor); ?>, 25px 25px <?php echo e($primaryBgColor); ?>, 26px 26px <?php echo e($primaryBgColor); ?>, 27px 27px <?php echo e($primaryBgColor); ?>, 28px 28px <?php echo e($primaryBgColor); ?>;
		-moz-text-shadow: 1px 1px <?php echo e($primaryBgColor20d); ?>, 2px 2px <?php echo e($primaryBgColor20d); ?>, 3px 3px <?php echo e($primaryBgColor20d); ?>, 4px 4px <?php echo e($primaryBgColor20d); ?>, 5px 5px <?php echo e($primaryBgColor20d); ?>, 6px 6px <?php echo e($primaryBgColor20d); ?>, 7px 7px <?php echo e($primaryBgColor20d); ?>, 8px 8px <?php echo e($primaryBgColor20d); ?>, 9px 9px <?php echo e($primaryBgColor20d); ?>, 10px 10px <?php echo e($primaryBgColor20d); ?>, 11px 11px <?php echo e($primaryBgColor20d); ?>, 12px 12px <?php echo e($primaryBgColor20d); ?>, 13px 13px <?php echo e($primaryBgColor); ?>, 14px 14px <?php echo e($primaryBgColor); ?>, 15px 15px <?php echo e($primaryBgColor); ?>, 16px 16px <?php echo e($primaryBgColor); ?>, 17px 17px <?php echo e($primaryBgColor); ?>, 18px 18px <?php echo e($primaryBgColor); ?>, 19px 19px <?php echo e($primaryBgColor); ?>, 20px 20px <?php echo e($primaryBgColor); ?>, 21px 21px <?php echo e($primaryBgColor); ?>, 22px 22px <?php echo e($primaryBgColor); ?>, 23px 23px <?php echo e($primaryBgColor); ?>, 24px 24px <?php echo e($primaryBgColor); ?>, 25px 25px <?php echo e($primaryBgColor); ?>, 26px 26px <?php echo e($primaryBgColor); ?>, 27px 27px <?php echo e($primaryBgColor); ?>, 28px 28px <?php echo e($primaryBgColor); ?>;
	}
	
	.skin .shape-0 {
		text-shadow: 1px 1px <?php echo e($primaryBgColor); ?>, 2px 2px <?php echo e($primaryBgColor); ?>, 3px 3px <?php echo e($primaryBgColor); ?>, 4px 4px <?php echo e($primaryBgColor); ?>, 5px 5px <?php echo e($primaryBgColor); ?>, 6px 6px <?php echo e($primaryBgColor); ?>, 7px 7px <?php echo e($primaryBgColor); ?>, 8px 8px <?php echo e($primaryBgColor); ?>, 9px 9px <?php echo e($primaryBgColor); ?>, 10px 10px <?php echo e($primaryBgColor); ?>, 11px 11px <?php echo e($primaryBgColor); ?>, 12px 12px <?php echo e($primaryBgColor); ?>, 13px 13px <?php echo e($primaryBgColor); ?>, 14px 14px <?php echo e($primaryBgColor); ?>, 15px 15px <?php echo e($primaryBgColor); ?>, 16px 16px <?php echo e($primaryBgColor); ?>, 17px 17px <?php echo e($primaryBgColor); ?>, 18px 18px <?php echo e($primaryBgColor); ?>, 19px 19px <?php echo e($primaryBgColor); ?>, 20px 20px <?php echo e($primaryBgColor); ?>, 21px 21px <?php echo e($primaryBgColor); ?>, 22px 22px <?php echo e($primaryBgColor); ?>, 23px 23px <?php echo e($primaryBgColor); ?>, 24px 24px <?php echo e($primaryBgColor); ?>, 25px 25px <?php echo e($primaryBgColor); ?>, 26px 26px <?php echo e($primaryBgColor); ?>, 27px 27px <?php echo e($primaryBgColor); ?>, 28px 28px <?php echo e($primaryBgColor); ?>;
		-moz-text-shadow: 1px 1px <?php echo e($primaryBgColor); ?>, 2px 2px <?php echo e($primaryBgColor); ?>, 3px 3px <?php echo e($primaryBgColor); ?>, 4px 4px <?php echo e($primaryBgColor); ?>, 5px 5px <?php echo e($primaryBgColor); ?>, 6px 6px <?php echo e($primaryBgColor); ?>, 7px 7px <?php echo e($primaryBgColor); ?>, 8px 8px <?php echo e($primaryBgColor); ?>, 9px 9px <?php echo e($primaryBgColor); ?>, 10px 10px <?php echo e($primaryBgColor); ?>, 11px 11px <?php echo e($primaryBgColor); ?>, 12px 12px <?php echo e($primaryBgColor); ?>, 13px 13px <?php echo e($primaryBgColor); ?>, 14px 14px <?php echo e($primaryBgColor); ?>, 15px 15px <?php echo e($primaryBgColor); ?>, 16px 16px <?php echo e($primaryBgColor); ?>, 17px 17px <?php echo e($primaryBgColor); ?>, 18px 18px <?php echo e($primaryBgColor); ?>, 19px 19px <?php echo e($primaryBgColor); ?>, 20px 20px <?php echo e($primaryBgColor); ?>, 21px 21px <?php echo e($primaryBgColor); ?>, 22px 22px <?php echo e($primaryBgColor); ?>, 23px 23px <?php echo e($primaryBgColor); ?>, 24px 24px <?php echo e($primaryBgColor); ?>, 25px 25px <?php echo e($primaryBgColor); ?>, 26px 26px <?php echo e($primaryBgColor); ?>, 27px 27px <?php echo e($primaryBgColor); ?>, 28px 28px <?php echo e($primaryBgColor); ?>;
		
		-webkit-text-shadow: 1px 1px <?php echo e($primaryBgColor); ?>, 2px 2px <?php echo e($primaryBgColor); ?>, 3px 3px <?php echo e($primaryBgColor); ?>, 4px 4px <?php echo e($primaryBgColor); ?>, 5px 5px <?php echo e($primaryBgColor); ?>, 6px 6px <?php echo e($primaryBgColor); ?>, 7px 7px <?php echo e($primaryBgColor); ?>, 8px 8px <?php echo e($primaryBgColor); ?>, 9px 9px <?php echo e($primaryBgColor); ?>, 10px 10px <?php echo e($primaryBgColor); ?>, 11px 11px <?php echo e($primaryBgColor); ?>, 12px 12px <?php echo e($primaryBgColor); ?>, 13px 13px <?php echo e($primaryBgColor); ?>, 14px 14px <?php echo e($primaryBgColor); ?>, 15px 15px <?php echo e($primaryBgColor); ?>, 16px 16px <?php echo e($primaryBgColor); ?>, 17px 17px <?php echo e($primaryBgColor); ?>, 18px 18px <?php echo e($primaryBgColor); ?>, 19px 19px <?php echo e($primaryBgColor); ?>, 20px 20px <?php echo e($primaryBgColor); ?>, 21px 21px <?php echo e($primaryBgColor); ?>, 22px 22px <?php echo e($primaryBgColor); ?>, 23px 23px <?php echo e($primaryBgColor); ?>, 24px 24px <?php echo e($primaryBgColor); ?>, 25px 25px <?php echo e($primaryBgColor); ?>, 26px 26px <?php echo e($primaryBgColor); ?>, 27px 27px <?php echo e($primaryBgColor); ?>, 28px 28px <?php echo e($primaryBgColor); ?>;
	...
	.skin .cookie-consent__agree:hover {
		background-color: <?php echo e($primaryBgColor20d); ?>;
	}
	...
	.skin .tags a:hover {
		border-color: <?php echo e($primaryBgColor10d); ?>;
	}
	
	
	<?php if(in_array($selectedSkin, ['yellow', 'sunFlower'])): ?>
	...
	.skin .navbar.navbar-site {
		background-color: <?php echo e($primaryBgColor); ?> !important;
		border: 1px solid <?php echo e($primaryBgColor); ?> !important;
	}
	...
	.skin .custom-radio .custom-control-input:disabled:checked ~ .custom-control-label::before {
		background-color: <?php echo e($primaryBgColor10d); ?>;
	}
	...
	.skin .swal2-styled.swal2-confirm:focus {
		box-shadow: 0 0 0 3px <?php echo e($primaryBgColor50); ?> !important;
	}
<?php endif; ?>
</style><?php /**PATH C:\Users\sjeew\OneDrive\Desktop\Buy me\resources\views/common/css/skin.blade.php ENDPATH**/ ?>