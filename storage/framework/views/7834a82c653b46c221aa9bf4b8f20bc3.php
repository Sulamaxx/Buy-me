<?php
    ...
    $wanted_posts = App\Models\Post::with('category', 'city', 'pictures')->where('post_type_id', 2)->limit(20)->get();
...
<?php echo $__env->first(
    ...
    ['widget' => $widget, 'sectionOptions' => $sectionOptions]
, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH F:\Work\Sulochana\Buyme.lk\Buy-me\resources\views/home/inc/stats.blade.php ENDPATH**/ ?>