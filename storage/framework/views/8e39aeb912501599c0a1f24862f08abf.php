                ...
                <div class="inner" style="background-color: transparent">
                    <h2 style="display: flex; align-items: center;">
                        ...
                        <a href="<?php echo e(data_get($widget, 'link')); ?>" class="sell-your-item"
                            ...
                            <?php echo e(data_get($widget, 'link_text', t('View more'))); ?> <i class="fas fa-chevron-right"
                                ...
                                <div class="card" style="border-radius: 0%;min-height: 275px">
                                    ...
                                    <div class="card-body"
                                        ...
                                        <h5 class="card-title"
                                            ...
                                            <a href="<?php echo e(\App\Helpers\UrlGen::post($post)); ?>" style="color: #666666;">
...
<?php /**PATH F:\Work\Sulochana\Buyme.lk\Buy-me\resources\views/search/inc/posts/widget/dummy2.blade.php ENDPATH**/ ?>