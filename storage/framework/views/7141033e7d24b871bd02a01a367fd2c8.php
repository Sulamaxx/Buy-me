			...
			<div class="d-md-flex">
				<div>
					<h4 class="card-title fw-bold">
						<span class="lstick d-inline-block align-middle"></span><?php echo e(trans('admin.Updated Listings')); ?>
				...
				<div class="ms-auto">
					...
					<button onclick="exportToExcel('updad-list')" class="btn btn-sm btn-light rounded shadow float-start">Export to Excel</button>
				</div>
			</div>
			
			<div class="table-responsive mt-md-3 mt-5 no-wrap">
				<table id="updad-list" class="table v-middle mb-0">
					<thead>
					<tr>
						...
						<th class="border-0"><?php echo e(trans('admin.updatedusr')); ?></th>
                        <th class="border-0"><?php echo e(trans('admin.updDate')); ?></th>
					</tr>
					</thead>
					<tbody>
					<?php if($updatedPosts->count() > 0): ?>
						<?php $__currentLoopData = $updatedPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<tr>
                                ...
                                <td class="td-nowrap"><?php echo e($post->updated_at); ?></td>
							</tr>
...
<?php $__env->stopPush(); ?>
<?php /**PATH F:\Work\Sulochana\Buyme.lk\Buy-me\resources\views/admin/dashboard/inc/updated-posts.blade.php ENDPATH**/ ?>