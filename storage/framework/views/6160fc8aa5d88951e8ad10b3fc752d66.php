            ...
            <div class="navbar-identity d-flex align-items-center justify-content-between p-sm-0">
                ...
                <div class="d-md-none d-flex align-items-center" style="margin-bottom: 20px">
                    <a id="btnPostAdlink1" class="btn btn-block btn-border btn-listing border-null me-2"
                       ...
                       href="<?php echo e($addListingUrl); ?>"<?php echo $addListingAttr; ?>>
                        <?php echo e(t('Create Listing')); ?>

                    </a>
                    <?php if($showCountryFlagNextLogo && $multiCountryIsEnabled && !empty($countryFlag24Url)): ?>
                    ...
                    <?php if(!auth()->check()): ?>
                        <li class="nav-item dropdown no-arrow open-on-hover d-md-block d-sm-none d-none">
                            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown" style="color: white">
                                <i class="fas fa-user"></i> <span><?php echo e(t('log_in')); ?></span> <i class="bi bi-chevron-down"></i>
                            </a>
                            <ul id="authDropdownMenu" class="dropdown-menu user-menu shadow-sm">
                                <li class="dropdown-item">
                                    <?php if(config('settings.security.login_open_in_modal')): ?>
                                        <a href="#quickLogin" class="nav-link" data-bs-toggle="modal" style="color: white"><i class="fas fa-user"></i> <?php echo e(t('log_in')); ?></a>
                                    <?php else: ?>
                                        <a href="<?php echo e(\App\Helpers\UrlGen::login()); ?>" class="nav-link" style="color: white"><i class="fas fa-user"></i> <?php echo e(t('log_in')); ?></a>
                                    <?php endif; ?>
                                </li>
                                <li class="dropdown-item">
                                    <a href="<?php echo e(\App\Helpers\UrlGen::register()); ?>" class="nav-link" style="color: white"><i class="far fa-user"></i> <?php echo e(t('sign_up')); ?></a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <?php else: ?>
                        <li class="nav-item dropdown no-arrow open-on-hover">
                            <a href="#" class="dropdown-toggle nav-link text-nowrap" data-bs-toggle="dropdown" style="color: white">
                                <i class="fas fa-user-circle"></i> <span><?php echo e(auth()->user()->name); ?></span>
