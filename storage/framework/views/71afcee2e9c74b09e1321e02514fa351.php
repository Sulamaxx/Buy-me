...
<div <?php echo $__env->make('admin.panel.inc.field_wrapper_attributes', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> >
	<label class="form-label fw-bolder" for="<?php echo e($field['name']); ?>"><?php echo $field['label']; ?></label>
	...
	<?php endif; ?>
</div><?php /**PATH F:\Work\Sulochana\Buyme.lk\Buy-me\resources\views/admin/panel/fields/number.blade.php ENDPATH**/ ?>