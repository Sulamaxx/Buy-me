...
use App\Http\Controllers\Api\MemberShopController; // shop code 1
//use App\Http\Controllers\Api\BannerController; // banner code 1
use App\Http\Controllers\Api\CatCombinationsController; //cat combinations code 1
...
// shops
Route::prefix('shops')
	->controller(MemberShopController::class)
	->group(function ($router) {
		$router->pattern('id', '[0-9]+');
