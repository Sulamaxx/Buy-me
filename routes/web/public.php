...
Route::post('posts/pgresponselink', [PaymentController::class, 'pgresponselink']);
Route::get('shop/{name}-{id}', [UserController::class, 'index_shop']); // for shop view
Route::get('shop/search', [UserController::class, 'index_shop_search']); // for shop view
//Route::get('bannerClick/{id}', [BannerController::class, 'bannerClickCount']); // for banner click count
// AUTH
	...
	->group(function ($router) {
		...
		Route::namespace('CreateOrEdit\MultiSteps')
			...
			->group(function ($router) {
				...
				Route::get('posts/veryfyphone/{pn}/{tk}', 'veryfypostphones');
				Route::get('posts/notifyphone/{pn}', 'notifypostphones');
...
Route::namespace('Account')
	...
	->group(function ($router) {
		...
		Route::post('messages/shops/{id}', [MessagesController::class, 'storeshop']); //contact shop
...
Route::namespace('Page')
	->group(function ($router) {
		Route::get(dynamicRoute('routes.pricing'), [PricingController::class, 'index']); //subscription Packages
        Route::get('pricing/{id}', [PricingController::class, 'index']); //subscription Packages
